                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;width:540px"> 
                       <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-image:url(https://otuoxp.stripocdn.email/content/guids/CABINET_2ba5c6d83c7b404a1c9e4ac77205a637/images/99191536833167609.png);border-color:#EFEFEF;border-style:solid;border-width:2px;background-position:center top;background-repeat:no-repeat" width="100%" cellspacing="0" cellpadding="0" background="https://otuoxp.stripocdn.email/content/guids/CABINET_2ba5c6d83c7b404a1c9e4ac77205a637/images/99191536833167609.png" role="presentation"> 
                         ...
                         <tr style="border-collapse:collapse"> 
                          <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="<%= paquete.imagen %>" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="205"></td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td align="center" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:29px;font-family:tahoma, verdana, segoe, sans-serif;line-height:44px;color:#333333"><strong>Datos del boleto</strong></p></td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td align="center" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:22px;font-family:tahoma, verdana, segoe, sans-serif;line-height:33px;color:#666666">
                          ${boletos.map(
                            (boleto) => `
                          <u><span style="color:null">Rifa:</span></u><br><span style="color:#000000">${boleto.nombre}</span><br>
                          <u><span style="color:null">Número(s):</span></u><br><span style="color:#000000">#${boleto.numero}</span><br>
                          `
                          )}
                          <u>Nombre:</u><br><span style="color:#000000"><%= entity.nombre %></span><br><u>Teléfono:</u><br><span style="color:#000000"><%= entity.celular %></span><br><u>Mail:</u><br><span style="color:#000000"><%= entity.mail %></span><br><u>Pedido:</u><br><span style="color:#000000"><%= entity.pedido %></span></p></td>                      
                         </tr> 
                         <tr style="border-collapse:collapse"> 
                          <td align="center" style="padding:0;Margin:0;padding-bottom:10px;font-size:0"> 
                           <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                             <tr style="border-collapse:collapse"> 
                              <td valign="top" align="center" style="padding:0;Margin:0;padding-right:10px"><a target="_blank" href="https://www.facebook.com/Yad-Lakala-1658596541093934/" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:16px;text-decoration:underline;color:#4B539F"><img title="Facebook" src="https://otuoxp.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td> 
                              <td valign="top" align="center" style="padding:0;Margin:0"><a target="_blank" href="https://www.instagram.com/yadlakala/" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:16px;text-decoration:underline;color:#4B539F"><img title="Instagram" src="https://otuoxp.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td> 
                             </tr> 
                           </table></td> 
                         </tr> 
                       </table></td> 
